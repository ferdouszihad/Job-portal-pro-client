const Banner = () => {
  return (
    <div className="carousel w-full h-[600px] rounded-none">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute rounded-b-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-7 pl-12 w-1/2">
            <h2 className="text-6xl font-bold">
              Found Your Dream Job and Super Employee
            </h2>
            <p>
            ...
            <div>
              <button className="btn btn-primary mr-5">Explore Jobs</button>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <img
          src="https://plus.unsplash.com/premium_photo-1665203421659-09089ede4ffa?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          className="w-full rounded-b-xl object-cover"
        />
        <div className="absolute rounded-b-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-7 pl-12 w-1/2">
